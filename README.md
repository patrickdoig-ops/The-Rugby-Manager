...
- [Engine Reference (`docs/engine.md`)](./docs/engine.md) — The authoritative guide on the game engine, covering the simulation loop, phase state machine, resolver formulas, fatigue system, and known gaps.
