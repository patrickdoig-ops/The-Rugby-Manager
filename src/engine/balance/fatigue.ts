...
export const FATIGUE_SCALING = {
  ...
  tiers: [
    ...
    { threshold: 70, multipliers: { pace: 0.75, agility: 0.75, handling: 0.95, discipline: 0.80, composure: 0.80, setPiece: 0.80, breakdown: 0.80, strength: 0.70 } },
    { threshold: 50, multipliers: { pace: 0.55, agility: 0.55, handling: 0.85, discipline: 0.60, composure: 0.60, setPiece: 0.60, breakdown: 0.60, strength: 0.50 } },
    { threshold: 30, multipliers: { pace: 0.35, agility: 0.35, handling: 0.70, discipline: 0.40, composure: 0.40, tackling: 0.40, setPiece: 0.30, breakdown: 0.30, strength: 0.30 } },
  ],
} as const;
