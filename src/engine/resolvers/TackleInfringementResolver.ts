...
// defending team's discipline tactic (risky +, cautious −). `strictnessMult` is
// the assigned referee's penalty strictness multiplier (1.0 = neutral).
export function tackleInfringement(defender: Player, disciplineMod = 0, strictnessMult = 1): TackleInfringement | undefined {
  const H = HIGH_TACKLE;
