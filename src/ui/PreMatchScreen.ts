    ...
    <div id="pm-header">
      ...
      <div id="pm-tabs-bar">
        <div id="pm-tabs" role="tablist">
          <button class="pm-tab active" data-tab="${playerSide}" style="--team-color:${playerTeam.color}">${playerTeam.shortName}</button>
          <button class="pm-tab"        data-tab="${oppSide}"    style="--team-color:${oppTeam.color}">${oppTeam.shortName}</button>
          <button class="pm-tab"        data-tab="tactics"       style="--team-color:var(--rm-pitch)">TACTICS</button>
        </div>
