  ...
  app.innerHTML = `
    ...
    <div id="sim-controls">
      <div id="ctrl-bar">
        ...
        <div id="auto-settings-popover" class="auto-settings-popover" hidden role="dialog" aria-label="Key moments">
          <span class="auto-settings-title">Key moments</span>
          <label class="auto-settings-row"><input type="radio" name="key-moment-mode" id="km-off"   value="off">   Off</label>
          <label class="auto-settings-row"><input type="radio" name="key-moment-mode" id="km-slow"  value="slow">  Slow to 1×</label>
          <label class="auto-settings-row"><input type="radio" name="key-moment-mode" id="km-pause" value="pause"> Pause</label>
        </div>
      </div>
    </div>
