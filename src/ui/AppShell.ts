export function buildAppShell(): void {
  ...
  app.innerHTML = `
    ...
    <div id="sim-controls">
      <div id="ctrl-bar">
        ...
        <div class="speed-presets" role="group" aria-label="Simulation speed">
          ...
          <button class="speed-btn" data-ms="200" aria-label="Octuple speed">8×</button>
        </div>
        <button id="btn-auto-settings" class="ctrl-btn" title="Settings" aria-label="Settings" aria-expanded="false">
    ...
    <div id="match-settings-overlay" class="match-settings-overlay hidden"></div>
