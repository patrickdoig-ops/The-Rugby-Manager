// Baked formation data for the 2D-pitch player-dot layer. Pure tables — no DOM, no
// engine, no functions: the slot→offset / slot→spot numbers that `placeFormation` and
// the kick-off / drop-out / scrum / lineout / maul layouts in `pitchChoreography.ts`
// consume. Split out of pitchChoreography so the ~900 lines of authored offsets sit
// apart from the geometry logic that places them.
//
// Authoring: most Formation frames are pasted exports from the Phase Animator (see
// docs/phase-animator.md). Re-author there and re-bake; don't hand-tune unless the
// doc-described nudge workflow says so.

import { SLOT } from '../engine/Slot';

export type FormOffsets = Record<number, readonly [number, number]>;
...
export interface Formation { nearTop: boolean; atk: FormOffsets; def: FormOffsets; atkFrom?: FormOffsets; defFrom?: FormOffsets; unclamped?: boolean;
...
export const BOX_KICK_ANNOUNCE: Formation = { nearTop: true,
  atk: {
...
export const BOX_KICK_RETAIN: Formation = { nearTop: true,
...
export const BOX_KICK_TO_TOUCH: Formation = { nearTop: true,
  atk: {
...
export const BOX_KICK_DEFEND_CATCH: Formation = { nearTop: true,
...
export const BOX_KICK_DEFEND_CONTESTED: Formation = { nearTop: false,
...
export const BOX_KICK_DEFEND_KNOCK_ON: Formation = { nearTop: true,
...
export const BOX_KICK_FORMS: Array<{ key: string; form: Formation }> = [
...
export const BREAKDOWN_CLEAN: Formation = { nearTop: false,
  atk: {
...
export const BREAKDOWN_CLEANOUT_PEN: Formation = { nearTop: true,
  atk: {
...
export const BREAKDOWN_SLOW_BALL: Formation = { nearTop: true,
  atk: {
...
export const BREAKDOWN_TURNOVER: Formation = { nearTop: true, defenderIsAttacker: true,
  atk: {
...
export const BREAKDOWN_NOT_ROLLING_AWAY: Formation = { nearTop: false, defenderIsAttacker: true,
  atk: {
...
export const BREAKDOWN_OFFSIDE_AT_RUCK: Formation = { nearTop: true, defenderIsAttacker: true,
  atk: {
...
export const BREAKDOWN_PENALTY_DEFENDING: Formation = { nearTop: false,
  atk: {
...
export const PENALTY_KICK_TO_TOUCH: Formation = { nearTop: true,
  atk: {
...
export const PENALTY_KICK_TO_TOUCH_CLOSE: Formation = { nearTop: true,
  atk: {
...
export const PENALTY_TAP_AND_GO: Formation = { nearTop: true,
  atk: {
...
export const PENALTY_TAP_AND_KICK_DEAD: Formation = { nearTop: true,
  atk: {
...
export const TACTICAL_KICK_BASE: Formation = { nearTop: true,
  atk: {
...
export const TACTICAL_KICK_FROZEN: Formation = {
...
// from == to.
export type KickoffSpot = { from: [number, number]; to: [number, number] };
export const KICKOFF_RECV: Record<number, KickoffSpot> = {
...
export const KICKOFF_KICK: Record<number, KickoffSpot> = {
...
export const KICKOFF_SHORT_RECV: Record<number, KickoffSpot> = {
...
export const KICKOFF_SHORT_KICK: Record<number, KickoffSpot> = {
...
export const DROPOUT_ANNOUNCE_KICK: Record<number, KickoffSpot> = {
...
export const DROPOUT_ANNOUNCE_RECV: Record<number, KickoffSpot> = {
...
export const DROPOUT_RECEIVE_KICK: Record<number, KickoffSpot> = {
...
export const DROPOUT_RECEIVE_RECV: Record<number, KickoffSpot> = {
...
export const CONV_ABS: Record<'atk' | 'def', Record<number, readonly [number, number]>> = {
  atk: {
...
export const SCRUM_ATK_BACKS: Array<{ slot: number; dX: number; dY: number }> = [
...
export const SCRUM_DEF_BACKS: Array<{ slot: number; dX: number; dY: number }> = [
...
export const LINEOUT_ATK_BACKS: Array<{ slot: number; dX: number; dY: number }> = [
  { slot: SLOT.FLY_HALF,    dX: 6.5,  dY: 32.3 },
  { slot: SLOT.CENTRE_12,   dX: 11.7, dY: 46.6 },
  { slot: SLOT.CENTRE_13,   dX: 16.3, dY: 32.3 },
  { slot: SLOT.FULL_BACK,   dX: 15.4, dY: 63.5 },
...
export const LINEOUT_DEF_BACKS: Array<{ slot: number; dX: number; dY: number }> = [
  { slot: SLOT.FLY_HALF,   dX: 10.5, dY: 30.7 },
  { slot: SLOT.CENTRE_12,  dX: 10.0, dY: 45.9 },
  { slot: SLOT.CENTRE_13,  dX: 10.4, dY: 61.0 },
  { slot: SLOT.FULL_BACK,  dX: 27.8, dY: 62.2 },
...
export const SCRUM_ROWS: Array<{ dx: number; cells: Array<{ slot: number; y: number }> }> = [
...
export const MAUL_ATK_ROWS: Array<{ dx: number; cells: Array<{ slot: number; y: number }> }> = [
