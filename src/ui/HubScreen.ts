...
interface TileSpec {
  ...
  handlerKey: 'onSquad' | 'onFixtures' | 'onLeague' | 'onTraining' | 'onContracts' | 'onTransfers' | 'onAchievements';
  stub?: boolean;
  sub?: string;
}
...
const TILES: TileSpec[] = [
  ...
  { id: 'hub-tile-achievements', ariaLabel: 'Achievements', label: 'Awards',    iconKey: 'achievements', handlerKey: 'onAchievements' },
];
