...
const ICONS = {
  ...
  loans: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5zm6-10.125a1.875 1.875 0 11-3.75 0 1.875 1.875 0 013.75 0zm1.294 6.336a6.721 6.721 0 01-3.17.789 6.721 6.721 0 01-3.168-.789 3.376 3.376 0 016.338 0z"/></svg>`,
...
interface TileSpec {
  ...
  handlerKey: 'onContracts' | 'onTransfers' | 'onLoans' | 'onScouting';
}
...
const TILES: TileSpec[] = [
  ...
  { id: 'ctm-tile-loans',     label: 'Loans',     sub: 'Development & cover',     ariaLabel: 'Loan management', iconKey: 'loans',     handlerKey: 'onLoans' },
];
