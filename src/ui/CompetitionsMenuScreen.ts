...
// Five tiles → Fixture List, League, League Cup, European Cup, European Shield.
...
interface TileSpec {
  ...
  handlerKey: 'onFixtureList' | 'onLeague' | 'onCup' | 'onEuropeanCup' | 'onEuropeanShield';
}

const TILES: TileSpec[] = [
  { id: 'cm-tile-fixture-list',    label: 'Fixture List',     sub: 'All competitions',       ariaLabel: 'Fixture List',    iconKey: 'fixtures', handlerKey: 'onFixtureList' },
