...
**Landed:** WP 0 ✅ · WP 1 ✅ · WP 2 ✅ · WP 3 ✅ · **WP 4 ✅** (heuristic ruck commitment feeding the unchanged `BreakdownResolver` as inputs + World persistence across contiguous spatial phases; 4 WP 4 scenarios — isolation jackal, cap override, 10-phase no-teleport continuity, fold-fatigue compounding — pass across 4 seeds, 20 spatial scenarios total; full 5-seed bands hold: pts 23.56, tries 3.62, TO 2.29, pen 12.16). **WP 4 deviations from the plan:**
