...
const ICONS = {
  ...
  assistant: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"/></svg>`,
  history: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>`,
};
...
interface TileSpec {
  ...
  handlerKey: 'onBoardConfidence' | 'onAssistantManager' | 'onStaff' | 'onFinances' | 'onAwards' | 'onClubHistory';
}
...
const TILES: TileSpec[] = [
  ...
  { id: 'cm-tile-assistant', label: 'Assistant Manager', sub: 'Delegate your League Cup', ariaLabel: 'Assistant Manager', iconKey: 'assistant', handlerKey: 'onAssistantManager' },
  ...
  { id: 'cm-tile-awards',    label: 'Awards',   sub: 'Honours & career milestones',   ariaLabel: 'Awards',           iconKey: 'awards',   handlerKey: 'onAwards' },
  { id: 'cm-tile-history',   label: 'Club History', sub: 'Seasons, records & Hall of Fame', ariaLabel: 'Club History', iconKey: 'history', handlerKey: 'onClubHistory' },
];
