...
function buildStatRows(d: DisplaySnapshot): StatRowSpec[] {
  ...
  return [
    ...
    { id: 'passes',           label: 'Passes',         homeVal: String(aggregates.passes.home), awayVal: String(aggregates.passes.away), homeNum: aggregates.passes.home, awayNum: aggregates.passes.away },
    ...
    { id: 'kicks',            label: 'Kicks',          homeVal: String(aggregates.kicks.home), awayVal: String(aggregates.kicks.away), homeNum: aggregates.kicks.home, awayNum: aggregates.kicks.away },
